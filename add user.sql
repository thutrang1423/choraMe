...
('5product', 'Áo sơ mi nữ cổ trụ thanh lịch.', 'Chorame', 'Cotton', 'Việt Nam', 'nữ', 'đông', TRUE),
('6product', 'Váy body ôm sát, tôn dáng, hở lưng, quyến rủ.', 'Chorame', 'Cotton', 'Việt Nam', 'nữ', 'xuân', TRUE),
('7product', 'Áo vest nữ cổ áo bèo mềm mại, nữ tính, thanh lịch', 'Chorame', 'Cotton', 'Việt Nam', 'nữ', 'xuân', FALSE),
('8product', 'Áo sơ mi nữ cổ sơ mi giản đơn, thanh lịch.', 'Chorame', 'Cotton', 'Việt Nam', 'nữ', 'thu', TRUE),
('9product', 'Váy body ôm sát xoè đuôi cá mềm mại, quyến rủ', 'Chorame', 'Cotton', 'Việt Nam', 'nữ', 'hạ', TRUE),
('10product', 'Áo vest cổ áo cách kiểu, thắt lưng ôm body nhẹ, tôn dáng.', 'Chorame', 'Cotton', 'Việt Nam', 'nữ', 'xuân', TRUE);
...
VALUES 
-- 10 khách hàng (user)
('user01', 'user01@example.com', '$2a$10$abc123456789', 'Nguyễn Văn A', 'customer'),

-- 3 nhân viên (admin)
('staff01', 'staff01@shop.com', '$2a$10$abc123456789', 'Lê Nhân Viên 1', 'staff'),

-- 1 chủ cửa hàng (admin)
('admin01', 'admin01@shop.com', '$2b$10$WTs0s2C.YP2SA9VD/nF/N..n47zA0dpP5NgLi92VCRG3u0ojK3CJ6', 'Chủ Cửa Hàng Trang', 'admin');
